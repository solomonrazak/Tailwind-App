...
const Sidebar = () => {
  return (
    <div className="pb-10">
        ...
        <div className="pl-2">
            <p className="text-gray-500 text-[14px] xl:text-[18px] font-medium mb-2">FEATURED</p>
            <div className="flex flex-col gap-1 pl-3">
                <div className="flex gap-6 items-center">
                    <p className="text-[15px] xl:text-[20px]">Hidden gems</p>
                    <img src={tag} width={30} h={25} className="object-contain mt-1"/>
                </div>
        ...
        <div className="px-3">
            <div className="flex justify-between w-full mb-4">
                <p className="text-gray-500 text-[14px] xl:text-[18px] font-medium md:pl-3 xl:pl-5">SAVED</p>
            ...
            <div className="flex w-full">
                ...
                <div className='w-full md:pl-5 xl:pl-9 space-y-3'>
                    <p className="text-[15px] xl:text-[18px] font-medium">All Saved</p>
                    <div className="flex items-center w-[100%] justify-between md:pr-4 xl:pr-7">
                        <p className="text-[15px] xl:text-[18px] font-medium">Board name</p>
            ...
            <p className="text-[15px] xl:text-[18px] font-medium pl-4 pt-3">View all boards</p>
        ...
        <div className="flex items-center gap-3 pl-4">
            ...
            <p className="font-medium md:text-[17px] xl:text-[23px]">My Account</p>
        </div>
